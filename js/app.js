...
const counts = data.reduce((prev, dat) => {
  if (prev[dat]) {
    prev[dat]++
  } else {
    prev[dat] = 1
...
const isOlder = devs.some(person => {
  return (2024 - person.year) >= 19
})

console.log('Problem 8:', isOlder)

// Array.prototype.every()
// 9. Check if everyone is 19 or older.

const allOlder = devs.every(person => {
  return (2024 - person.year) >= 19
})

console.log('Problem 9:', allOlder)
...
console.log('Problem 10:', comment)

// Array.prototype.findIndex()
// 11. Find the index of the comment with an id of 123523.

const idx = comments.findIndex(comm => {
  return comm.id === 123523
})

console.log('Problem 11:', idx)
